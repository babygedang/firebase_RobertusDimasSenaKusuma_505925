...
class MainActivity : AppCompatActivity(), CatatanAdapter.DeleteNoteListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        notesAdapter = CatatanAdapter(mutableListOf())
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == ADD_NOTE_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            val newNote = data?.getSerializableExtra("newNote") as? Catatan
    ...
    private fun loadNotesFromFirestore() {
        firestore.collection("notes")
            ...
            .addOnSuccessListener { result ->
                ...
                val notesList = ArrayList<Catatan>()
    ...
    override fun onNoteDeleted(note: Catatan) {
