...
import com.example.firebase.databinding.ActivityUpdateCatatanBinding
...
// Mendeklarasikan kelas untuk UpdateNoteActivity, yang mengembangkan AppCompatActivity.
 class UpdateCatatanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val note = intent.getSerializableExtra("note") as? Catatan
    ...
    private fun updateNoteInFirestore(updatedNote: Catatan) {
    ...
    private fun returnResultToMainActivity(updatedNote: Catatan) {
